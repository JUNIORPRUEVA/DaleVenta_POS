...
const Map<AppRole, Set<AppPermission>> rolePermissions = {
  AppRole.admin: {
    ...
    AppPermission.viewGaleriaPublicidad,
    ...
    AppPermission.viewTechnicalNetwork,
    AppPermission.viewTechnicalNetworkApplications,
    AppPermission.reviewTechnicalNetworkApplications,
    AppPermission.approveTechnicalNetworkApplications,
    AppPermission.rejectTechnicalNetworkApplications,
    AppPermission.createTechnicalNetworkTechnicians,
    AppPermission.editTechnicalNetworkTechnicians,
    AppPermission.deactivateTechnicalNetworkTechnicians,
    AppPermission.viewTechnicalNetworkPrivateDocuments,
    AppPermission.registerTechnicalNetworkJobs,
    AppPermission.evaluateTechnicalNetworkTechnicians,
