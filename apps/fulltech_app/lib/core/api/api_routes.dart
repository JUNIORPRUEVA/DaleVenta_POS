...
class ApiRoutes {
  ...
  static String crmCommercialConversationRead(String id) =>
      '/crm-commercial/conversations/$id/read';
  ...
  static String purchaseOrderDuplicate(String id) =>
      '/purchases/orders/$id/duplicate';
  static String purchaseOrderReceive(String id) =>
  ...
  static String purchaseInvoice(String id) => '/purchases/invoices/$id';
  ...
  static const marketingDebugMetaN8nCompatibility =
      '/marketing/debug/meta-n8n-compatibility';
