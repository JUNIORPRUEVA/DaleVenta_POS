...
class RedTecnicaRepository {
  ...
  Future<TechnicianApplication> submitApplication(
    ...
    final application = TechnicianApplication(
      ...
      sector: draft.sector,
      manualAddress: draft.manualAddress.trim(),
      ...
      locationSource: draft.locationSource.trim(),
      ...
      resumeOriginalName: draft.resumeOriginalName,
      resumeMimeType: draft.resumeMimeType,
      resumeSizeBytes: draft.resumeSizeBytes,
  ...
  Future<Technician> approveApplication({
    ...
    final technician = Technician(
      ...
      manualAddress: application.manualAddress,
      formattedAddress: application.formattedAddress,
      latitude: application.latitude,
      longitude: application.longitude,
      locationAccuracy: application.locationAccuracy,
  ...
  Future<Technician?> _tryRemoteCreateTechnician(Technician technician) async {
    ...
    try {
      ...
      return Technician(
        ...
        manualAddress: technician.manualAddress,
        formattedAddress: technician.formattedAddress,
        latitude: technician.latitude,
        longitude: technician.longitude,
        locationAccuracy: technician.locationAccuracy,
        locationCapturedAt: technician.locationCapturedAt,
        locationSource: technician.locationSource,
        ...
        resumePath: technician.resumePath,
        resumeOriginalName: technician.resumeOriginalName,
        resumeMimeType: technician.resumeMimeType,
        resumeSizeBytes: technician.resumeSizeBytes,
  ...
  Map<String, dynamic> _applicationToJson(TechnicianApplication item) => {
    ...
    'locationCapturedAt': item.locationCapturedAt?.toIso8601String(),
    ...
    'resumeOriginalName': item.resumeOriginalName,
    'resumeMimeType': item.resumeMimeType,
    'resumeSizeBytes': item.resumeSizeBytes,
    ...
    'consentAcceptedAt': item.consentAcceptedAt?.toIso8601String(),
  ...
  TechnicianApplication _applicationFromJson(Map<String, dynamic> json) {
    return TechnicianApplication(
      ...
      manualAddress: s(json, 'manualAddress'),
      formattedAddress: s(json, 'formattedAddress'),
      latitude: json['latitude'] == null ? null : d(json['latitude']),
      longitude: json['longitude'] == null ? null : d(json['longitude']),
      locationAccuracy: json['locationAccuracy'] == null
          ? null
          : d(json['locationAccuracy']),
      locationCapturedAt: dt(json['locationCapturedAt']),
      locationSource: s(json, 'locationSource'),
      ...
      resumePath: s(json, 'resumePath'),
      resumeOriginalName: s(json, 'resumeOriginalName'),
      resumeMimeType: s(json, 'resumeMimeType'),
      resumeSizeBytes: json['resumeSizeBytes'] == null
          ? null
          : i(json['resumeSizeBytes']),
      ...
      consentAccepted: b(json['consentAccepted']),
      consentAcceptedAt: dt(json['consentAcceptedAt']),
