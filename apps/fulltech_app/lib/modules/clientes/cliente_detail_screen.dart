...
class _ClienteDetailScreenState extends ConsumerState<ClienteDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasLocationDetail =
        normalizeClientLocationUrl(displayLocationUrl).isNotEmpty ||
                          ...
                          children: [
                            ...
                            _ElegantSectionCard(
                              child: Column(
                                ...
                                children: [
                                  const _SectionLabel(
                                    title: 'Datos importantes del cliente',
                                  ),
                                  const SizedBox(height: 14),
...
class _ElegantSectionCard extends StatelessWidget {
  const _ElegantSectionCard({
    required this.child,
