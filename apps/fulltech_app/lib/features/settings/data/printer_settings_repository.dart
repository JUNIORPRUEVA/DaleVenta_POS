...
class PrinterSettingsRepository {
  ...
  Future<void> _ensureSchema(Database db) async {
    await db.execute('''
      CREATE TABLE IF NOT EXISTS $_table (
        ...
        autoPrintOnPayment INTEGER NOT NULL DEFAULT 0,
  ...
  static const Map<String, String> _columnDefinitions = {
    ...
    'autoPrintOnPayment': 'autoPrintOnPayment INTEGER NOT NULL DEFAULT 0',
    ...
    'sectionSeparatorStyle':
        "sectionSeparatorStyle TEXT NOT NULL DEFAULT 'single'",
    'headerAlignment': "headerAlignment TEXT NOT NULL DEFAULT 'center'",
